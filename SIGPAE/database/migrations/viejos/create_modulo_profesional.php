...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('personas', function (Blueprint $table) {
            $table->id('id_persona'); // Clave primaria personalizada
            $table->string('nombre');
        ...
        Schema::create('profesionales', function (Blueprint $table) {
            ...
            //HEREDA DE PERSONAS
            $table->foreignId('persona')->constrained('personas', 'id_persona')->onDelete('cascade');
            $table->timestamps();
        });

        Schema::create('alumnos', function (Blueprint $table) {
            $table->id('id_alumno'); // Clave primaria personalizada
            ...
            $table->string('situacion_salud')->nullable();
            $table->string('situacion_familiar')->nullable();
            $table->string('situacion_economica')->nullable();
            //HEREDA DE PERSONAS
            $table->foreignId('persona')->constrained('personas', 'id_persona')->onDelete('cascade');
            //$table->foreignId('aula')->constrained('aulas', 'id_aula')->onDelete('set null');
            $table->timestamps();
        });

        Schema::create('familiares', function (Blueprint $table) {
            $table->id('id_familiar'); // Clave primaria personalizada
