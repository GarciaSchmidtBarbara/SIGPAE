...
@section('contenido')
    ...
    <form action="{{ route('planillas.acta-reuniones-banda.store') }}" method="POST">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
            ...
            <div class="flex flex-wrap items-center justify-center gap-6 mb-8">
                <div class="flex items-center gap-2">
                    ...
                    <input type="text" id="grado" name="grado" class="border border-gray-300 rounded px-2 py-1 w-16 text-center" placeholder="1 A">
                </div>
                <div class="flex items-center gap-2">
                    <label for="fecha" class="font-bold text-gray-700">Fecha:</label>
                    <input type="date" id="fecha" name="fecha" class="border border-gray-300 rounded px-2 py-1 text-gray-600">
                </div>
                <div class="flex items-center gap-2">
                    <label for="hora" class="font-bold text-gray-700">Hora:</label>
                    <input type="time" id="hora" name="hora" class="border border-gray-300 rounded px-2 py-1 text-gray-600">
                </div>
            </div>
            ...
            <div class="mt-8 space-y-6">    
             ...
             <div x-data="{ contenido: '' }">
                 ...
                 <textarea x-model="contenido" id="temario" name="temario" rows="4" class="w-full border border-gray-300 rounded px-2 py-1 no-imprimir" placeholder="Ingrese el temario..."></textarea>
             ...
             <div x-data="{ contenido: '' }">
                 ...
                 <textarea x-model="contenido" id="acuerdo" name="acuerdo" rows="4" class="w-full border border-gray-300 rounded px-2 py-1 no-imprimir" placeholder="Ingrese el acuerdo..."></textarea>
                 <div class="solo-imprimir text-justify whitespace-pre-wrap border-b border-gray-300 pb-2" x-text="contenido"></div>
             </div>
             ...
             <div x-data="{ contenido: '' }">
                 ...
                 <textarea x-model="contenido" id="observaciones" name="observaciones" rows="4" class="w-full border border-gray-300 rounded px-2 py-1 no-imprimir" placeholder="Ingrese observaciones..."></textarea>
                 <div class="solo-imprimir text-justify whitespace-pre-wrap border-b border-gray-300 pb-2" x-text="contenido"></div>
             </div>
            ...
            <div class="mt-8 flex items-center gap-3">
                ...
                <input type="date" id="proxima_reunion" name="proxima_reunion" class="border border-gray-300 rounded px-3 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
