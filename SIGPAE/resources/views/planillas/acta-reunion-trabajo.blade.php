...
@section('contenido')
    ...
    @php
        // ¿Estoy editando / viendo una planilla ya guardada?
        $esEdicion   = isset($planilla);
        $soloLectura = $soloLectura ?? false;

        // Datos del JSON de la planilla (si existe)
        ...
        // Próxima reunión (el <input type="date"> ya guarda yyyy-mm-dd)
    ...
    <form
        ...
        action="{{ $esEdicion
                    ...
                    : route('planillas.acta-reunion-trabajo.store') }}"
    >
        @csrf
        @if($esEdicion)
            @method('PUT')
                ...
                <div class="mt-10 pt-6 border-t border-gray-200">
                    <div class="fila-botones justify-between items-center">
                        <div class="flex gap-3">
                            ...
                            {{-- Por ahora “Descargar” también imprime, como en las otras --}}
                            <button type="button" class="btn-aceptar" onclick="window.print()">
                                Descargar
                            </button>
